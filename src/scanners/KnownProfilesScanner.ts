...
const KNOWN_TROLL_PROFILES: string[] = [
    ...
    'YoshiYamamo_to', 'CzeslawJesiono6', 'KacapMSK', 'Laweta2', 'marian_konarski', 'SurkovAndrey', 'NikifPL',
    ...
    'olimpia_szuwar', 'duchpl', 'digi_jacek', 'leszek93', 'KSokolowska123', 'Boska_Polka', 'Backyardbadboy', 'OwUmys',
    ...
    'neoficialniybezsonov', 'Michali49393358', 'Mitol_ns', 'Kris77Tany', 'WisiaSlav', 'KSisior', 'RussianInCracow',
    'MaciejMateus', 'DemonDakki', 'AbickiAwek', 'PartiaKresowian', 'CryptoD64437226', 'uszinek', 'Albert301271', 'Cernovich',
    ...
    'SputnikPolskaOfficial', 'CzeKuku', 'stranahan', 'annagaranin', 'niezaleznatelewizja', 'michimalsa', 'gazetastonoga',
    'PiotrWiel', 'Boska96541976', 'ewa_insomnia', 'BerekPolski', 'MinistersAcosta', 'JSmigowski', 'AcostaInstytut',
    '_I_ukas', 'kazumidai'
];
